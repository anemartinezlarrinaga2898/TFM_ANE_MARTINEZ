...
Filtrados <- readRDS("AnalisisGSEA_BP/GenesFiltrados/AnalisisGSEA_Lusc_1_Filtrados.rds")
...
saveRDS(RFiltrados,"Graficos_GSEA_BP/Resultados_Filtrados_BP_Lusc_1.rds")
saveRDS(RTotales,"Graficos_GSEA_BP/Resultados_Totales_BP_Lusc_1.rds")

# Ahora graficamos: 

RFiltrados <- readRDS("Graficos_GSEA_BP/Resultados_Filtrados_BP_Lusc_1.rds")
RTotales <- readRDS("Graficos_GSEA_BP/Resultados_Totales_BP_Lusc_1.rds")
...
annotate_figure(figura,
                top = text_grob("Biological Process Group 1 Lusc", color = "Black", size = 14))
...
Filtrados <- readRDS("AnalisisGSEA_BP/GenesFiltrados/AnalisisGSEA_Lusc_2_Filtrados.rds")
...
saveRDS(RTotales,"Graficos_GSEA_BP/Resultados_Totales_BP_Lusc_2.rds")

# Ahora graficamos: 

RTotales <- readRDS("Graficos_GSEA_BP/Resultados_Totales_BP_Lusc_2.rds")

GR_1T <- ggplot(RTotales[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Count))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="Biological Process, Group 2 ,Total Genes, Lusc")
GR_1T
...
Filtrados <- readRDS("AnalisisGSEA_BP/GenesFiltrados/AnalisisGSEA_Lusc_3_Filtrados.rds")
...
saveRDS(RTotales,"AnalisisGSEA_BP/Resultados_Totales_BP_Lusc_3.rds")

# Ahora graficamos: 

RTotales <- readRDS("AnalisisGSEA_BP/Resultados_Totales_BP_Lusc_3.rds")

GR_1T <- ggplot(RTotales[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Count))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="Biological Process, Group 3 ,Total Genes, Lusc")
GR_1T
