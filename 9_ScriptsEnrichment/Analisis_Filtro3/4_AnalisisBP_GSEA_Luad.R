...
GLF <- readRDS("Analisis_Filtro3/Objetos_GSEA/FILTRADO/GLF1_Luad.rds")
GSEA_BP_F <- gseGO(geneList = GLF, 
                  ...
                  verbose = FALSE,
                  eps=0) 
saveRDS(GSEA_BP_F,"Analisis_Filtro3/Resultados/GSEA/GSEA_Grupo1_Luad_Filtrado.rds")
...
GLF <- readRDS("Analisis_Filtro3/Objetos_GSEA/FILTRADO/GLF2_Luad.rds")
GSEA_BP_F <- gseGO(geneList = GLF, 
                   OrgDb = org.Hs.eg.db, 
                   ont = 'BP',  
                   minGSSize = 10, 
                   ...
                   verbose = FALSE,
                   eps=0) 
saveRDS(GSEA_BP_F,"Analisis_Filtro3/Resultados/GSEA/GSEA_Grupo2_Luad_Filtrado.rds")
Filtrados <- GSEA_BP_F
...
GLF <- readRDS("Analisis_Filtro3/Objetos_GSEA/FILTRADO/GLF3_Luad.rds")
GSEA_BP_F <- gseGO(geneList = GLF, 
                   OrgDb = org.Hs.eg.db, 
                   ont = 'BP',  
                   minGSSize = 10, 
...
saveRDS(GSEA_BP_F,"Analisis_Filtro3/Resultados/GSEA/GSEA_Grupo3_Luad_Filtrado.rds")
...
GR_1F <- ggplot(RFiltrados, aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Count))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="Filtered Genes")
GR_1F
