...
RT <- readRDS("AnalisisGSEA_Halmarks/GenesTotales/AnalisisGSEA_Luad_1_Total_Hallamarks.rds")
...
saveRDS(ID_Cuentas,"Resultados_Hallmarks_Totales_Luad_1.rds")

# GRAFICAMOS: 

RT <- readRDS("Graficos_GSEA_Halmarks/Resultados_Hallmarks_Totales_Luad_1.rds")
...
GH <- ggplot(H[1:15,], aes(x=NES, y=Description))+
  ...
  labs(title="Hallmark Genes , Group 1 Luad")
GH
...
GC2 <- ggplot(C2[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C2 Genes , Group 1 Luad")
GC2
...
GC6 <- ggplot(C6[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C6 Genes , Group 1 Luad")
GC6
...
RT <- readRDS("AnalisisGSEA_Halmarks/GenesTotales/AnalisisGSEA_Luad_2_Total_Hallamarks.rds")
...
saveRDS(ID_Cuentas,"Graficos_GSEA_Halmarks/Resultados_Hallmarks_Totales_Luad_2.rds")

# GRAFICAMOS: 

RT <- readRDS("Graficos_GSEA_Halmarks/Resultados_Hallmarks_Totales_Luad_2.rds")
...
GH <- ggplot(H[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="Hallmark Genes , Group 2 Luad")
GH
...
GC2 <- ggplot(C2[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C2 Genes , Group 2 Luad")
GC2
...
GC6 <- ggplot(C6[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C6 Genes , Group 2 Luad")
GC6

GC7 <- ggplot(C7[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C7 Genes , Group 2 Luad")
GC7

# C O M P A R A C I O N   3: ·································································

RF <- readRDS("AnalisisGSEA_Halmarks/GenesFitlrados/AnalisisGSEA_Luad_3_Filtrado_Hallamarks.rds")
RT <- readRDS("AnalisisGSEA_Halmarks/GenesTotales/AnalisisGSEA_Luad_3_Total_Hallamarks.rds")
...
saveRDS(ID_Cuentas,"Graficos_GSEA_Halmarks/Resultados_Hallmarks_Totales_Luad_3.rds")

# GRAFICAMOS: 

RT <- readRDS("Graficos_GSEA_Halmarks/Resultados_Hallmarks_Totales_Luad_3.rds")
...
GH <- ggplot(H[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="Hallmark Genes , Group 3 Luad")
GH
...
GC2 <- ggplot(C2[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C2 Genes , Group 3 Luad")
GC2
...
GC6 <- ggplot(C6[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C6 Genes , Group 3 Luad")
GC6

GC7 <- ggplot(C7[1:15,], aes(x=NES, y=Description))+
  geom_point(aes(colour=p.adjust,size=Cuentas))+
  scale_color_gradientn(colours=rainbow(4), limits=c(0, 0.05))+
  labs(title="C7 Genes , Group 3 Luad")
GC7
