...
#OBJETIVO:Script para obtener los data.frame de 0 y 1 para saber si son superiores a la medio o a la mediana de LUSC
...
Matriz_3_DOWN <- t(Matriz_3[[1]])

MatrizTraspuesta_1 <- list(Matriz_1_UP,Matriz_1_DOWN)
MatrizTraspuesta_2 <- Matriz_2_UP
MatrizTraspuesta_3 <- Matriz_3_DOWN

saveRDS(MatrizTraspuesta_1,"MatrizTranscripcion_UP_DOWN_Lusc_1.rds")
saveRDS(MatrizTraspuesta_2,"MatrizTranscripcion_UP_DOWN_Lusc_2.rds")
saveRDS(MatrizTraspuesta_3,"MatrizTranscripcion_UP_DOWN_Lusc_3.rds")

Matrices <- list(Matriz_1_UP,Matriz_1_DOWN,Matriz_2_UP,Matriz_3_DOWN)
...
names(SumatorioMatrices) <- c("1_UP","1_DOWN","2_UP","3_DOWN")
condiciones <- c("1_UP","1_DOWN","2_UP","3_DOWN")
...
saveRDS(InformacionTotal,"Informacion_UP_DOWN_SinClinica_Lusc.rds")
