...
MatrizGenesPerfilTranscripcional <- readRDS("MatrizGenesPerfilTranscripcional_Lusc.rds")

#·······························  L U S C ·······························································

Matriz_1 <- MatrizGenesPerfilTranscripcional[[1]]
Matriz_2 <- MatrizGenesPerfilTranscripcional[[2]]
Matriz_3 <- MatrizGenesPerfilTranscripcional[[3]]

Matriz_1 <- t(Matriz_1)
Matriz_2 <- t(Matriz_2)
Matriz_3 <- t(Matriz_3)

saveRDS(Matriz_1,"MatrizTranscripcion_Lusc_1.rds")
saveRDS(Matriz_2,"MatrizTranscripcion_Lusc_2.rds")
saveRDS(Matriz_3,"MatrizTranscripcion_Lusc_3.rds")

Sumatorio_Matriz_1 <- t(rowSums(Matriz_1))
Sumatorio_Matriz_2 <- t(rowSums(Matriz_2))
Sumatorio_Matriz_3 <- t(rowSums(Matriz_3))
...
saveRDS(Sumatorio_Matriz_1,"Sumatorio_Matriz_1_Lusc.rds")
saveRDS(Sumatorio_Matriz_2,"Sumatorio_Matriz_2_Lusc.rds")
saveRDS(Sumatorio_Matriz_3,"Sumatorio_Matriz_3_Lusc.rds")
...
rownames(Informacion_1) <- rownames(Matriz_1)
rownames(Informacion_2) <- rownames(Matriz_2)
rownames(Informacion_3) <- rownames(Matriz_3)
...
saveRDS(TotalInformacion,"InformacionTotal_SinClinica_Lusc.rds")

# OBNTENCION DE LA INFORMACION CLINICA: 

Informacion <- readRDS("InformacionTotal_SinClinica_Lusc.rds")
...
saveRDS(Informacion_Clinica_1,"Informacion_Clinica_Lusc_1.rds")
saveRDS(Informacion_Clinica_2,"Informacion_Clinica_Lusc_2.rds")
saveRDS(Informacion_Clinica_3,"Informacion_Clinica_Lusc_3.rds")
