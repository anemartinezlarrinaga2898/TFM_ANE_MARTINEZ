...
saveRDS(res_nb_silhouette, 'res_nb_silhouette_500.rds') #AQUI APARECERA UN 100 o un 500 dependiendo de las veces que realicemos el bucle
saveRDS(res_nb_dindex, 'res_nb_dindex_500.rds')
saveRDS(res_nb_dunn, 'res_nb_dunn_500.rds')
saveRDS(res_nb_gap, 'res_nb_gap_500.rds')
saveRDS(res_nb_tau, 'res_nb_tau_500.rds')
