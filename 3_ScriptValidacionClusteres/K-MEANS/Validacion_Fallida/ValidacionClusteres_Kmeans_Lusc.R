...
saveRDS(res_nb_silhouette, 'res_nb_silhouette_500_lusc.rds')
saveRDS(res_nb_dindex, 'res_nb_dindex_500_lusc.rds')
saveRDS(res_nb_dunn, 'res_nb_dunn_500_lusc.rds')
saveRDS(res_nb_gap, 'res_nb_gap_500_lusc.rds')
saveRDS(res_nb_tau, 'res_nb_tau_500_lusc.rds')
