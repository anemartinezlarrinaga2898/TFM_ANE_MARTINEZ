...
venn.diagram(
  ...
  lty = 1,
  col=c("#7FB3D5", '#A569BD'),
  fill = c(alpha("#7FB3D5",0.5), alpha('#A569BD',0.5)),
  cat.cex = 0.6,
  cat.fontface = "bold",
...
saveRDS(Anotaciones_NivelesExpresion_TG1,"Comparacion8/Anotaciones_NivelesExpresion_TG1.rds")
saveRDS(Anotaciones_NivelesExpresion_TG2,"Comparacion8/Anotaciones_NivelesExpresion_TG2.rds")
saveRDS(Anotaciones_NivelesExpresion_Duplicados,"Comparacion8/Anotaciones_NivelesExpresion_Duplicados.rds")
