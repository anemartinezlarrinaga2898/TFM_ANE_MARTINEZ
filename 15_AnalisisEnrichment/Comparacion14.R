...
#OBJETIVO:# COMPARACION 14: Grupo 2 de LUSC que es inmunogenico frente al grupo 1 de LUAD que tambien es imunogenico, pero sin tener en cuenta el GO TERM. 
...
venn.diagram(
  ...
  filename = "Comparacion_Grupo_1_LUAD_frente_a_Grupo_2_LUSC_HUELLA_2.png",
  output=TRUE,
  lwd = 2,
  lty = 1,
  col=c("#A3B2F7", '#B1F7A3'),
...
saveRDS(Anotaciones_NivelesExpresion_TG1,"Comparacion14/Anotaciones_NivelesExpresion_TG1.rds")
saveRDS(Anotaciones_NivelesExpresion_TG2,"Comparacion14/Anotaciones_NivelesExpresion_TG2.rds")
saveRDS(Anotaciones_NivelesExpresion_Duplicados,"Comparacion14/Anotaciones_NivelesExpresion_Duplicados.rds")
