...
#OBJETIVO:# COMPARACION 11: Grupo 2 LUSC GSEA frente al grupo 3 LUSC GSEA. Ambos uno es no inmunogenico y el otro si. 
...
TG1 <- readRDS("DatosPartida/GSEA/AnalisisGSEA_Lusc_2_Total.rds")
...
#······································································································
GeneList_TG1 <- readRDS("DatosPartida/GSEA/GeneListTotales/GeneList_Comparacion_2_Lusc_Total.rds")
GeneList_TG2 <- readRDS("DatosPartida/GSEA/GeneListTotales/GeneList_Comparacion_3_Lusc_Total.rds")
...
venn.diagram(
  ...
  category.names = c("Grupo 2 LUSC" , "Grupo 3 LUSC "),
  filename = "Comparacion_Grupo_2_LUSC_frente_a_Grupo_3_LUSC_GSEATOTAL.png",
  output=TRUE,
  lwd = 2,
  lty = 1,
  col=c("#A3B2F7", '#B1F7A3'),
...
saveRDS(Anotaciones_NivelesExpresion_TG1,"Comparacion11/Anotaciones_NivelesExpresion_TG1.rds")
saveRDS(Anotaciones_NivelesExpresion_TG2,"Comparacion11/Anotaciones_NivelesExpresion_TG2.rds")
saveRDS(Anotaciones_NivelesExpresion_Duplicados,"Comparacion11/Anotaciones_NivelesExpresion_Duplicados.rds")
