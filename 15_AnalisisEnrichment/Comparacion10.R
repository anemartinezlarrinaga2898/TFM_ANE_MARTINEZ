...
#OBJETIVO:# COMPARACION 10: Grupo 3 LUAD GSEA frente al grupo 3 LUSC GSEA. Ambos son grupos no inmunogenicos. 
...
venn.diagram(
  ...
  lty = 1,
  col=c("#16A085", '#F7A3F3'),
  fill = c(alpha("#16A085",0.5), alpha('#F7A3F3',0.5)),
  cat.cex = 0.6,
  cat.fontface = "bold",
...
saveRDS(Anotaciones_NivelesExpresion_TG1,"Comparacion10/Anotaciones_NivelesExpresion_TG1.rds")
saveRDS(Anotaciones_NivelesExpresion_TG2,"Comparacion10/Anotaciones_NivelesExpresion_TG2.rds")
saveRDS(Anotaciones_NivelesExpresion_Duplicados,"Comparacion10/Anotaciones_NivelesExpresion_Duplicados.rds")
