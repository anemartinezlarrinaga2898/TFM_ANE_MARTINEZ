...
for (i in seq_along(NumeroCluster)){
  ...
  if (Grupo==NumeroCluster[1]){K3 <- GruposKmeans_Lusc %>% filter(k==Grupo)}
  else if (Grupo==NumeroCluster[2]){K4 <- GruposKmeans_Lusc %>% filter(k==Grupo)} 
  else {K5 <- GruposKmeans_Lusc %>% filter(k==Grupo)}
}
...
K3.1 <- K3 %>% filter(cluster==1) # 211 pacientes
K3.2 <- K3 %>% filter(cluster==2) # 253 pacientes
K3.3 <- K3 %>% filter(cluster==3) # 31 pacientes
...
# Cantidad en cada grupo:  203   2   6 
...
Comprobacion_3.1_5
# Numero de grupo:        1   3   4 
# Cantidad en cada grupo: 90  116   5 
...
Comprobacion_3.2_4
# Numero de grupo:        1   2   3 
# Cantidad en cada grupo: 7 194  52 
...
Comprobacion_3.2_5
# Numero de grupo:        1   2   3   4 
# Cantidad en cada grupo: 8 173  22  50 
...
Comprobacion_3.3_4
# Numero de grupo:        2  3  4 
# Cantidad en cada grupo: 1  3 27 
...
Comprobacion_3.3_5
# Numero de grupo:        2  4  5 
# Cantidad en cada grupo: 1  5 25
 # K3
###################################################################################
# ··························· K = 4 ···········································

K4.1 <- K4 %>% filter(cluster==1) # 210 pacientes
K4.2 <- K4 %>% filter(cluster==2) # 197 pacientes
K4.3 <- K4 %>% filter(cluster==3) # 61 pacientes
K4.4 <- K4 %>% filter(cluster==4) # 27 pacientes
...
Comprobacion_4.2_3
# Numero de grupo:        1   2   3 
# Cantidad en cada grupo: 2 194   1      
...
Comprobacion_4.2_5
# Numero de grupo:       1   2   3        
# Cantidad en cada grupo:5 174  18 
