...
#OBJETIVO:# COMPARACION 17: Comparacion de las tres huellas para sacar los genes que son unicos de cada grupo LUSC
# HUELLA 2
###########################################################################################################################################################################################################################################################################################v###################################
library(tidyverse)
library(VennDiagram)
...
saveRDS(G1,"Comparacion17/G1.rds")
saveRDS(G2,"Comparacion17/G2.rds")
saveRDS(G3,"Comparacion17/G3.rds")
