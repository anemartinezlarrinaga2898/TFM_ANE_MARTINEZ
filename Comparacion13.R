...
#OBJETIVO:# COMPARACION 13: Grupo 3 de luad frente al grupo 3 de LUSC con la huella 3 
...
GeneList_TG1 <- readRDS("DatosPartida/GSEA/GeneListFiltro3/GLF3_Luad.rds")
GeneList_TG2 <- readRDS("DatosPartida/GSEA/GeneListFiltro3/GLF3_Lusc.rds")
...
saveRDS(Anotaciones_NivelesExpresion_TG1,"Comparacion13/Anotaciones_NivelesExpresion_TG1.rds")
saveRDS(Anotaciones_NivelesExpresion_TG2,"Comparacion13/Anotaciones_NivelesExpresion_TG2.rds")
saveRDS(Anotaciones_NivelesExpresion_Duplicados,"Comparacion13/Anotaciones_NivelesExpresion_Duplicados.rds")
